...
def _build_system_prompt(context: Optional[dict] = None) -> str:
    ...
    system_parts.extend([
        ...
        "- Compare-Modus: Vergleich von Szenarien, Modellen oder Zeitpunkten als Differenzkarte (eine einzige Karte)",
        "- Split View: Zwei separate Karten nebeneinander ('side by side', 'nebeneinander', 'gleichzeitig')",
        ...
        "",
        "# Farblegende und Farbskalenbereich:",
        "- Die Legende hat einen Schloss/Pin-Button, der ein 'Fixed range'-Tooltip öffnet.",
        "- Nutzer können Min/Max-Werte manuell eingeben, um die Farbskala der Karte zu fixieren.",
        "- 'Reset': Setzt den Bereich auf das globale Daten-Min/Max zurück.",
        "- 'Fit to masks': Wenn binäre Masken aktiv sind, setzt dieser Button den Bereich auf das Min/Max der *sichtbaren* (unmaskierten) Pixel — die Farbskala konzentriert sich auf die angezeigten Daten.",
        "- 'Unpin': Entfernt den fixierten Bereich und kehrt zur automatischen Skalierung zurück.",
        "- Der Bereich kann auch vom KI-Assistenten über ein Werkzeug gesetzt werden (z.B. 'Setze die Farbskala auf 10–35°C').",
        "",
        "# Masken und Filter:",
        "- Binäre Masken: Zeigen nur Bereiche, die in den angegebenen Wertgrenzen liegen",
        "- Wahrscheinlichkeitsmasken: Zeigen nur Bereiche mit einer bestimmten Wahrscheinlichkeit (z.B. 20% = 0.2)",
        "- Verwende 'kind': 'probability' für Wahrscheinlichkeitsmasken",
        "- 'probabilityThreshold': Wert zwischen 0 und 1 (z.B. 0.2 für 20%)",
        "- 'lowerBound' und 'upperBound': Definieren den Wertebereich für die Bedingung",
        "",
        "# Wichtige Hinweise:",
